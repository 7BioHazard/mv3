...
local PlayerGui = (not tostring(identifyexecutor()):match("ScriptWare") and (gethui and gethui().Parent) or game:GetService("CoreGui")) or game.Players.LocalPlayer:WaitForChild("PlayerGui")
